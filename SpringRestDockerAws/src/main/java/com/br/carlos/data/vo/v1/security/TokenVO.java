package com.br.carlos.data.vo.v1.security;
...
public class TokenVO implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result + ((refeshToken == null) ? 0 : refeshToken.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (expiration == null) {
			...
			return false;
		if (refeshToken == null) {
			if (other.refeshToken != null)
				return false;
		} else if (!refeshToken.equals(other.refeshToken))
			return false;
		if (username == null) {
